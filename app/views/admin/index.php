            ...
            <?php foreach ($entradas as $entrada): ?>
                <tr>
                    ...
                    <td data-label="Acciones" class="admin-actions">
                        ...
                        <form action="<?= URLROOT ?>/admin/borrar/<?= $entrada['id'] ?>" method="POST" style="display:inline;" onsubmit="return confirm('¿Confirma la eliminación definitiva de este registro?')">
